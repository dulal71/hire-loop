...
import { addJobApplication } from '@/lib/action/application';
...
const JobApply = ({ job, applicant }) => {
 ...
 applicantName: applicant?.name,
        ...
        // // Handle your API submission here
         const res = await addJobApplication(submissionData);
        if (res.insertedId) {
    ...
    return (
        <div className="max-w-xl mx-auto p-6 my-5 bg-white dark:bg-zinc-900 rounded-xl shadow-sm border border-zinc-200 dark:border-zinc-800">
            {/* Header Section */}
            <div className="mb-6">
